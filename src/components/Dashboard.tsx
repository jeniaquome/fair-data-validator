  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Validation Dashboard</h2>
          <p className="text-sm sm:text-base text-gray-600">Monitor FAIR compliance across all experimental data submissions</p>
        </div>
        <button
          onClick={onNewValidation}
          className="bg-blue-600 text-white px-3 sm:px-4 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center gap-2 text-sm sm:text-base w-full sm:w-auto justify-center"
        >
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-4 sm:p-6 border-b border-gray-200">
          <div className="flex flex-col gap-4">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900">Validation Reports Archive</h3>
              ...
              >
                ...
                <div className="flex items-center justify-between text-xs text-gray-500 mt-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-gray-700">{scorePercent}%</span>
                  </div>
                </div>
              </div>
            )
        ...
        <div className="hidden sm:block overflow-x-auto">
          <table className="w-full min-w-[800px]">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Report</th>
                <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Type</th>
                <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Researcher</th>
              ...
              {filteredReports.map((report) => {
                ...
                return (
                  <tr key={report.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 lg:px-6 py-4 text-sm text-gray-600">{report.researcher}</td>
                    <td className="px-4 lg:px-6 py-4">
                      <div className="flex items-center gap-2">
